...
@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h1>Keuangan</h1>
                <a href="{{ route('kwarcab.keuangan.create') }}" class="btn btn-primary rounded">Tambah Transaksi</a>
                            ...
                            @forelse($keuangan as $item)
                                <tr>
                                    ...
                                    <td class="d-flex gap-1">
                                        <a href="{{ route('kwarcab.keuangan.edit', $item->id) }}"
                                            class="btn btn-sm btn-warning">Edit</a>
                                        <form action="{{ route('kwarcab.keuangan.destroy', $item->id) }}" method="POST"
