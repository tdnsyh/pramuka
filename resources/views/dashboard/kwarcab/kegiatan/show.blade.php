        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <form action="{{ route('kwarcab.kegiatan.galeri.store', $kegiatan->id) }}" method="POST"
                                ...
                                @foreach ($kegiatan->galeri as $foto)
                                    <div class="col-6 col-md-3">
                                        <div class="position-relative border rounded overflow-hidden">
                                            ...
                                            <form
                                                action="{{ route('kwarcab.kegiatan.galeri.destroy', [$kegiatan->id, $foto->id]) }}"
                ...
                <a href="{{ route('kwarcab.kegiatan.index') }}" class="btn btn-outline-secondary rounded">Kembali</a>
            </div>
        </div>
