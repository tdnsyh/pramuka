    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST"
                    action="{{ isset($kegiatan) ? route('kwarran.kegiatan.update', $kegiatan) : route('kwarran.kegiatan.store') }}"
                    ...
                    <a href="{{ route('kwarran.kegiatan.index') }}" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
