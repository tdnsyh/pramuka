...
@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h1>Keuangan</h1>
                <a href="{{ route('kwarran.keuangan.create') }}" class="btn btn-primary rounded">Tambah Transaksi</a>
                        ...
                        <tbody>
                            @forelse($keuangan as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('kwarran.keuangan.edit', $item->id) }}"
                                            class="btn btn-sm btn-warning">Edit</a>
                                        <form action="{{ route('kwarran.keuangan.destroy', $item->id) }}" method="POST"
